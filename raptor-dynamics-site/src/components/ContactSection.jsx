...
const socials = [
  {
    label: 'LinkedIn',
    href: 'https://in.linkedin.com/company/raptor-dynamics-nie?trk=public_post_feed-actor-name',
    icon: (
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/raptordynamicsnie/',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    label: 'GitHub',
    href: 'https://github.com/raptor-dynamics-nie',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="mb-16 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
          <ScrollReveal variant="fadeUp" delay={0.1}>
            <motion.h2 
              className="font-display text-[clamp(3rem,8vw,7rem)] leading-[0.9] tracking-tight inline-block cursor-crosshair origin-left" 
      ...
      <div className="grid lg:grid-cols-5 gap-12 relative z-10">
        ...
        <div className="lg:col-span-2 flex flex-col gap-4">
          {[
            ...
            { label: 'Email',       value: 'raptordynamicsnie@gmail.com',            icon: '✉' },
